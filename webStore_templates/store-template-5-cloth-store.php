<?php
// ========================================================
// Tapify WhatsApp Web Store Template 5: Cloth Store
// CSS File: cloth_store.css
// ========================================================

// ---- SHOP INFORMATION ----
$shop_name      = 'Aapka Fashion Store';
$shop_tagline   = 'Style That Speaks For You';
...
// ---- CATEGORIES ----
$categories = [
  ['id' => 1, 'name' => 'Men',         'image' => 'images/cat1.jpg'],
  ['id' => 2, 'name' => 'Women',       'image' => 'images/cat2.jpg'],
  ['id' => 3, 'name' => 'Kids',        'image' => 'images/cat3.jpg'],
  ['id' => 4, 'name' => 'Accessories', 'image' => 'images/cat4.jpg'],
];
...
// ---- TEMPLATE INFO ----
$template_id  = 5;
$template_name= 'Cloth Store';
$css_file     = 'cloth_store';
...
<head>
    ...
    <title><?php echo htmlspecialchars($shop_name); ?> – Fashion & Clothing</title>
    ...
    <style>
        :root { --accent:#6a1b9a; --accent-light:#f3e5f5; }
        *, *::before, *::after { box-sizing:border-box; }
        ...
        .prod-img { width:100%; aspect-ratio:3/4; object-fit:cover; display:block; transition:transform .35s; }
        ...
        .badge-new { position:absolute; top:8px; right:8px; background:var(--accent); color:#fff; font-size:.66rem; padding:3px 9px; border-radius:50px; font-weight:600; }
...
<div class="banner-wrap">
    ...
    <div class="banner-overlay">
        <div>
            ...
            <a href="https://wa.me/<?php echo $whatsapp_no; ?>" target="_blank" class="btn-wa">
                <i class="fab fa-whatsapp"></i> Shop the Collection
            </a>
        </div>
    </div>
</div>
...
<div class="store-wrap">
    ...
    <section class="sec" id="categories">
        ...
        <div class="cat-strip">
            <div class="cat-item active" onclick="filterCategory(0,this)">
                <div class="cat-all"><i class="fas fa-tshirt text-white" style="font-size:1.2rem;"></i></div>
                <span>All</span>
            </div>
    ...
    <section class="sec" id="collection" style="padding-top:0;">
        <h2 class="sec-title">Latest <span>Collection</span></h2>
            ...
            <div class="col-6 col-md-4 col-lg-3 product-item" data-category="<?php echo $product['category_id']; ?>">
                <div class="product-card">
                    <div class="prod-img-box">
                        ...
                        <?php if(!empty($product['sale_price'])): ?><span class="badge-sale">SALE</span><?php elseif($product['in_stock']): ?><span class="badge-new">NEW</span><?php endif; ?>
                    </div>
                    <div class="prod-body">
        ...
        <div class="row g-4">
            <div class="col-12 col-md-6">
                <div class="info-card">
                    ...
                    <ul class="hours-list">
                        <li><span>Monday – Friday</span><span class="fw-600" style="color:#2e7d32;">10:00 AM – 8:00 PM</span></li>
                        <li><span>Saturday</span><span class="fw-600" style="color:#2e7d32;">9:00 AM – 9:00 PM</span></li>
                        <li><span>Sunday</span><span class="fw-600" style="color:#f57c00;">11:00 AM – 6:00 PM</span></li>
                    </ul>
                </div>
            </div>
...
<a href="https://wa.me/<?php echo $whatsapp_no; ?>" class="float-wa" target="_blank" title="Order Clothes">
    <i class="fab fa-whatsapp"></i>
</a>
