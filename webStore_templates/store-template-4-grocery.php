<?php
// ========================================================
// Tapify WhatsApp Web Store Template 4: Grocery Store
// CSS File: grocery_store.css
// ========================================================

// ---- SHOP INFORMATION ----
$shop_name      = 'Aapki Grocery Shop';
$shop_tagline   = 'Fresh & Fast Delivery';
...
// ---- CATEGORIES ----
$categories = [
  ['id' => 1, 'name' => 'Fruits',      'image' => 'images/cat1.jpg'],
  ['id' => 2, 'name' => 'Vegetables',  'image' => 'images/cat2.jpg'],
  ['id' => 3, 'name' => 'Dairy',       'image' => 'images/cat3.jpg'],
  ['id' => 4, 'name' => 'Grains',      'image' => 'images/cat4.jpg'],
];
...
$products = [
  [
    'id'          => 1,
    'name'        => 'Item 1 Ka Naam',
    'description' => 'Item ki description yahan likhein.',
    'price'       => 149,
    'sale_price'  => 119,
...
<head>
    ...
    <title><?php echo htmlspecialchars($shop_name); ?> – Fresh Grocery</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing:border-box; }
        ...
        .badge-fresh { position:absolute; top:8px; right:8px; background:#2e7d32; color:#fff; font-size:.66rem; padding:3px 9px; border-radius:50px; font-weight:600; }
...
<div class="banner-wrap">
    ...
    <div class="banner-overlay">
        <div>
            ...
            <a href="https://wa.me/<?php echo $whatsapp_no; ?>" target="_blank" class="btn-wa">
                <i class="fab fa-whatsapp"></i> Order Groceries
            </a>
        </div>
    </div>
</div>
...
<div class="store-wrap">
    ...
    <section class="sec" id="categories">
        ...
        <div class="cat-strip">
            <div class="cat-item active" onclick="filterCategory(0,this)">
                <div class="cat-all"><i class="fas fa-shopping-basket text-white" style="font-size:1.2rem;"></i></div>
                <span>All</span>
            </div>
    ...
    <section class="sec" id="products" style="padding-top:0;">
        <h2 class="sec-title">Fresh <span>Groceries</span></h2>
            ...
            <div class="col-6 col-md-4 col-lg-3 product-item" data-category="<?php echo $product['category_id']; ?>">
                <div class="product-card">
                    <div class="prod-img-box">
                        ...
                        <?php if(!empty($product['sale_price'])): ?><span class="badge-sale">SALE</span><?php elseif($product['in_stock']): ?><span class="badge-fresh">FRESH</span><?php endif; ?>
                    </div>
                    <div class="prod-body">
        ...
        <div class="row g-4">
            <div class="col-12 col-md-6">
                <div class="info-card">
                    ...
                    <ul class="hours-list">
                        <li><span>Monday – Saturday</span><span class="fw-600" style="color:#2e7d32;">7:00 AM – 9:00 PM</span></li>
                        <li><span>Sunday</span><span class="fw-600" style="color:#2e7d32;">8:00 AM – 6:00 PM</span></li>
                        <li><span>Public Holidays</span><span class="fw-600" style="color:#f57c00;">9:00 AM – 4:00 PM</span></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                ...
                <ul>
                    ...
                    <li>Holidays: 9:00 AM – 4:00 PM</li>
                </ul>
            </div>
        </div>
    </div>
...
<a href="https://wa.me/<?php echo $whatsapp_no; ?>" class="float-wa" target="_blank" title="Order Groceries">
    <i class="fab fa-whatsapp"></i>
</a>
