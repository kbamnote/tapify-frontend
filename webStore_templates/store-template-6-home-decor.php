...
// ---- SHOP INFORMATION ----
$shop_name      = 'Aapka Home Decor Store';
$shop_tagline   = 'Beautiful Homes Start Here';
...
// ---- CATEGORIES ----
$categories = [
  ['id' => 1, 'name' => 'Living Room', 'image' => 'images/cat1.jpg'],
  ['id' => 2, 'name' => 'Bedroom',     'image' => 'images/cat2.jpg'],
  ['id' => 3, 'name' => 'Kitchen',     'image' => 'images/cat3.jpg'],
  ['id' => 4, 'name' => 'Garden',      'image' => 'images/cat4.jpg'],
];
...
<head>
    ...
    <title><?php echo htmlspecialchars($shop_name); ?> – Home Decor</title>
    ...
    <style>
        :root { --accent:#4e342e; --accent-light:#efebe9; }
        *, *::before, *::after { box-sizing:border-box; }
        ...
        .prod-img { width:100%; aspect-ratio:4/3; object-fit:cover; display:block; transition:transform .35s; }
...
<div class="banner-wrap">
    ...
    <div class="banner-overlay">
        <div>
            ...
            <a href="https://wa.me/<?php echo $whatsapp_no; ?>" target="_blank" class="btn-wa">
                <i class="fab fa-whatsapp"></i> Explore Collection
            </a>
        </div>
    </div>
</div>
...
<div class="store-wrap">
    ...
    <section class="sec" id="categories">
        <h2 class="sec-title">Browse by <span>Room</span></h2>
        <div class="cat-strip">
            <div class="cat-item active" onclick="filterCategory(0,this)">
                <div class="cat-all"><i class="fas fa-home text-white" style="font-size:1.2rem;"></i></div>
                <span>All</span>
            </div>
    ...
    <section class="sec" id="collection" style="padding-top:0;">
        <h2 class="sec-title">Decor <span>Collection</span></h2>
            ...
            <div class="col-6 col-md-4 col-lg-3 product-item" data-category="<?php echo $product['category_id']; ?>">
                <div class="product-card">
                    ...
                    <div class="prod-body">
                        ...
                        <a href="https://wa.me/<?php echo $whatsapp_no; ?>?text=<?php echo urlencode('Hi! I\'m interested in: '.$product['name'].' – '.$currency.($product['sale_price'] ?: $product['price'])); ?>"
                           class="btn-order" target="_blank">
                            <i class="fab fa-whatsapp"></i>
                            <?php echo $product['in_stock'] ? 'Enquire Now' : 'Out of Stock'; ?>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6">
                <div class="info-card">
                    ...
                    <ul class="hours-list">
                        ...
                        <li><span>Sunday</span><span class="fw-600" style="color:#f57c00;">11:00 AM – 5:00 PM</span></li>
                    </ul>
                </div>
            </div>
            <div class="col-12 col-md-6" id="contact">
                <div class="info-card">
                    <h2 class="sec-title">Visit <span>Us</span></h2>
...
<a href="https://wa.me/<?php echo $whatsapp_no; ?>" class="float-wa" target="_blank" title="Enquire Now">
    <i class="fab fa-whatsapp"></i>
</a>
