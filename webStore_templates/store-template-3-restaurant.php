...
// ---- SHOP INFORMATION ----
$shop_name      = 'Aapka Restaurant Ka Naam';
$shop_tagline   = 'Swaad Mein Sabse Aage';
...
// ---- CATEGORIES ----
$categories = [
  ['id' => 1, 'name' => 'Starters',    'image' => 'images/cat1.jpg'],
  ['id' => 2, 'name' => 'Main Course', 'image' => 'images/cat2.jpg'],
  ['id' => 3, 'name' => 'Desserts',    'image' => 'images/cat3.jpg'],
  ['id' => 4, 'name' => 'Drinks',      'image' => 'images/cat4.jpg'],
];
...
$products = [
  [
    'id'          => 1,
    'name'        => 'Dish 1 Ka Naam',
    'description' => 'Dish ki description yahan likhein.',
    'price'       => 299,
    'sale_price'  => 0,
...
<head>
    ...
    <title><?php echo htmlspecialchars($shop_name); ?> – Menu</title>
    ...
    <style>
        :root { --accent:#d84315; --accent-light:#fbe9e7; }
        *, *::before, *::after { box-sizing:border-box; }
        ...
        .banner-overlay { display:none; position:absolute; inset:0; background:linear-gradient(to right,rgba(0,0,0,.7) 0%,rgba(0,0,0,0) 65%); align-items:center; padding:40px 48px; }
        ...
        .badge-veg { position:absolute; top:8px; right:8px; background:#2e7d32; color:#fff; font-size:.66rem; padding:3px 9px; border-radius:50px; font-weight:600; }
...
<div class="banner-wrap">
    ...
    <div class="banner-overlay">
        <div>
            ...
            <a href="https://wa.me/<?php echo $whatsapp_no; ?>" target="_blank" class="btn-wa">
                <i class="fab fa-whatsapp"></i> Order Food Now
            </a>
        </div>
    </div>
</div>
...
<div class="store-wrap">
    ...
    <section class="sec" id="categories">
        <h2 class="sec-title">Food <span>Categories</span></h2>
        <div class="cat-strip">
            <div class="cat-item active" onclick="filterCategory(0,this)">
                <div class="cat-all"><i class="fas fa-utensils text-white" style="font-size:1.2rem;"></i></div>
                <span>All</span>
            </div>
    ...
    <section class="sec" id="menu" style="padding-top:0;">
        <h2 class="sec-title">Our <span>Menu</span></h2>
            ...
            <div class="col-6 col-md-4 col-lg-3 product-item" data-category="<?php echo $product['category_id']; ?>">
                <div class="product-card">
                    <div class="prod-img-box">
                        ...
                        <?php if(!$product['in_stock']): ?><span class="badge-oos">Unavailable</span><?php endif; ?>
                        <?php if($product['in_stock']): ?><span class="badge-veg">Available</span><?php endif; ?>
                    </div>
                    <div class="prod-body">
                        ...
                        <a href="https://wa.me/<?php echo $whatsapp_no; ?>?text=<?php echo urlencode('Hi! I\'d like to order: '.$product['name'].' – '.$currency.($product['sale_price'] ?: $product['price'])); ?>"
                           class="btn-order" target="_blank">
                            <i class="fab fa-whatsapp"></i>
                            <?php echo $product['in_stock'] ? 'Order Now' : 'Enquire'; ?>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <section class="sec" id="hours">
        <div class="row g-4">
            <div class="col-12 col-md-6">
                <div class="info-card">
                    <h2 class="sec-title">Opening <span>Hours</span></h2>
                    <ul class="hours-list">
                        <li><span>Monday – Friday</span><span class="fw-600" style="color:#2e7d32;">10:00 AM – 10:00 PM</span></li>
                        <li><span>Saturday</span><span class="fw-600" style="color:#2e7d32;">10:00 AM – 11:00 PM</span></li>
                        <li><span>Sunday</span><span class="fw-600" style="color:#2e7d32;">11:00 AM – 9:00 PM</span></li>
                    </ul>
                </div>
            </div>
            <div class="col-12 col-md-6" id="contact">
                <div class="info-card">
                    <h2 class="sec-title">Find <span>Us</span></h2>
                    <ul class="contact-list">
                        ...
                        <?php endif; ?>
                        <li><i class="fab fa-whatsapp ci"></i><a href="https://wa.me/<?php echo $whatsapp_no; ?>" target="_blank" style="color:#25D366;font-weight:600;">Order on WhatsApp</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<a href="https://wa.me/<?php echo $whatsapp_no; ?>" class="float-wa" target="_blank" title="Order Food">
    <i class="fab fa-whatsapp"></i>
</a>
