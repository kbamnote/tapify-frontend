<?php
// ========================================================
// Tapify WhatsApp Web Store Template 7: Jewellery
// CSS File: jewellery.css
// ========================================================

// ---- SHOP INFORMATION ----
$shop_name      = 'Aapka Jewellery Store';
$shop_tagline   = 'Timeless Elegance, Crafted For You';
$logo           = 'images/logo.jpg';
$banner_image   = 'images/banner.jpg';
$whatsapp_no    = '919999999999';
$phone          = '+91 99999 99999';
$email          = 'jewellery@email.com';
$address        = 'Aapka Pata, Shehar, State, PIN';
$currency       = '₹';

// ---- CATEGORIES ----
$categories = [
  ['id' => 1, 'name' => 'Gold',      'image' => 'images/cat1.jpg'],
  ['id' => 2, 'name' => 'Diamond',   'image' => 'images/cat2.jpg'],
  ['id' => 3, 'name' => 'Silver',    'image' => 'images/cat3.jpg'],
  ['id' => 4, 'name' => 'Gemstone',  'image' => 'images/cat4.jpg'],
];
...
$products = [
  [
    'id'          => 1,
    'name'        => 'Jewellery 1 Ka Naam',
    'description' => 'Jewellery ki description yahan likhein.',
    'price'       => 15999,
    'sale_price'  => 12999,
...
<head>
    ...
    <title><?php echo htmlspecialchars($shop_name); ?> – Fine Jewellery</title>
    ...
    <style>
        :root { --accent:#b8860b; --accent-light:#fff8e1; }
        *, *::before, *::after { box-sizing:border-box; }
        body { font-family:'Poppins',sans-serif; background:#f9f6f0; margin:0; color:#333; }
        ...
        .product-card { border-radius:14px; overflow:hidden; box-shadow:0 2px 12px rgba(0,0,0,.07); background:#fff; height:100%; display:flex; flex-direction:column; transition:transform .3s, box-shadow .3s; border:1px solid #f0e8d0; }
        .product-card:hover { transform:translateY(-5px); box-shadow:0 10px 28px rgba(0,0,0,.13); }
        .prod-img-box { position:relative; overflow:hidden; background:#fafaf8; }
        ...
        .badge-premium { position:absolute; top:8px; right:8px; background:var(--accent); color:#fff; font-size:.66rem; padding:3px 9px; border-radius:50px; font-weight:600; }
...
<nav class="store-nav">
    <div class="nav-inner">
        ...
        <div class="nav-links">
            <a href="#jewellery">Collections</a>
            <a href="#hours">Hours</a>
            <a href="#contact">Contact</a>
        </div>
        <a href="https://wa.me/<?php echo $whatsapp_no; ?>" target="_blank" class="btn-wa">
            <i class="fab fa-whatsapp"></i>
            <span class="btn-wa-full">Enquire on WhatsApp</span>
            <span class="btn-wa-short">Enquire</span>
        </a>
    </div>
</nav>
...
<div class="banner-wrap">
    ...
    <div class="banner-overlay">
        <div>
            ...
            <a href="https://wa.me/<?php echo $whatsapp_no; ?>" target="_blank" class="btn-wa">
                <i class="fab fa-whatsapp"></i> View Collections
            </a>
        </div>
    </div>
</div>
...
<div class="store-wrap">
    ...
    <section class="sec" id="categories">
        <h2 class="sec-title">Our <span>Collections</span></h2>
        <div class="cat-strip">
            <div class="cat-item active" onclick="filterCategory(0,this)">
                <div class="cat-all"><i class="fas fa-gem text-white" style="font-size:1.2rem;"></i></div>
                <span>All</span>
            </div>
    ...
    <section class="sec" id="jewellery" style="padding-top:0;">
        <h2 class="sec-title">Fine <span>Jewellery</span></h2>
            ...
            <div class="col-6 col-md-4 col-lg-3 product-item" data-category="<?php echo $product['category_id']; ?>">
                <div class="product-card">
                    <div class="prod-img-box">
                        ...
                        <?php if(!$product['in_stock']): ?><span class="badge-oos">Sold Out</span><?php endif; ?>
                        <?php if($product['in_stock']): ?><span class="badge-premium">PREMIUM</span><?php endif; ?>
                    </div>
                    <div class="prod-body">
                        ...
                        <a href="https://wa.me/<?php echo $whatsapp_no; ?>?text=<?php echo urlencode('Hi! I\'m interested in: '.$product['name'].' priced at '.$currency.($product['sale_price'] ?: $product['price'])); ?>"
                           class="btn-order" target="_blank">
                            <i class="fab fa-whatsapp"></i>
                            <?php echo $product['in_stock'] ? 'Enquire Now' : 'Sold Out'; ?>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <section class="sec" id="hours">
        <div class="row g-4">
            <div class="col-12 col-md-6">
                <div class="info-card">
                    <h2 class="sec-title">Showroom <span>Hours</span></h2>
                    <ul class="hours-list">
                        <li><span>Monday – Friday</span><span class="fw-600" style="color:#2e7d32;">10:00 AM – 7:00 PM</span></li>
                        <li><span>Saturday</span><span class="fw-600" style="color:#2e7d32;">10:00 AM – 8:00 PM</span></li>
                        <li><span>Sunday</span><span class="fw-600" style="color:#f57c00;">By Appointment</span></li>
                    </ul>
                </div>
            </div>
...
<a href="https://wa.me/<?php echo $whatsapp_no; ?>" class="float-wa" target="_blank" title="Enquire on WhatsApp">
    <i class="fab fa-whatsapp"></i>
</a>
