<?php
// ========================================================
// Tapify WhatsApp Web Store Template 1: Beauty Product
// CSS File: beauty-products.css
// ========================================================
// SETUP INSTRUCTIONS:
...
// ---- CATEGORIES ----
$categories = [
  ['id' => 1, 'name' => 'Skincare',   'image' => 'images/cat1.jpg'],
  ['id' => 2, 'name' => 'Makeup',     'image' => 'images/cat2.jpg'],
  ['id' => 3, 'name' => 'Hair Care',  'image' => 'images/cat3.jpg'],
  ['id' => 4, 'name' => 'Fragrance',  'image' => 'images/cat4.jpg'],
];
...
// ---- TEMPLATE INFO ----
$template_id  = 1;
$template_name= 'Beauty Product';
$css_file     = 'beauty-products';
...
<head>
    ...
    <title><?php echo htmlspecialchars($shop_name); ?> – Beauty Products</title>
    ...
    <style>
        :root { --accent:#e91e8c; --accent-light:#fce4ec; }
        *, *::before, *::after { box-sizing:border-box; }
        ...
        .banner-img { width:100%; height:210px; object-fit:cover; object-position:center; display:block; transition:opacity .3s; }
...
<div class="store-wrap">
    ...
    <section class="sec" id="products" style="padding-top:0;">
        <h2 class="sec-title">Our <span>Beauty Products</span></h2>
    ...
    <section class="sec" id="hours">
        <div class="row g-4">
            <div class="col-12 col-md-6">
                <div class="info-card">
                    <h2 class="sec-title">Business <span>Hours</span></h2>
                    <ul class="hours-list">
