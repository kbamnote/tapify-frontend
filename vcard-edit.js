...
const templates = [
    ...
    { id: 'vcard51', name: 'Handyman Services Pro', category: 'Services', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v51.png', demoUrl: '../newTemps/imagesHandyman/clean.html' },
    { id: 'vcard52', name: 'Interior Designer Pro', category: 'Design', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v52.png', demoUrl: '../newTemps/imagesInteriorDesigner/clean.html' },
    ...
    { id: 'vcard58', name: 'Retail & Ecommerce Pro', category: 'Retail', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v58.png', demoUrl: '../newTemps/imagesRetailEcommerce/clean.html' },
    ...
    { id: 'vcard72', name: 'Business Beacon', category: 'Business', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v72.png', demoUrl: '../newTemps/tempsNewAdded/Business Beacon/Business Beacon ｜ Tapify (7_6_2026 1：33：42 PM).html' },
    { id: 'vcard73', name: 'Clean Canvas', category: 'Business', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v73.png', demoUrl: '../newTemps/tempsNewAdded/Clean Canvas/Clean Canvas ｜ Tapify (7_6_2026 3：11：43 PM).html' },
    { id: 'vcard74', name: 'Corporate Classic', category: 'Corporate', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v74.png', demoUrl: '../newTemps/tempsNewAdded/Corporate Classic/John Doe ｜ Tapify (7_6_2026 1：31：45 PM).html' },
    { id: 'vcard75', name: 'Corporate Connect', category: 'Corporate', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v75.png', demoUrl: '../newTemps/tempsNewAdded/Corporate Connect/Core-Connect ｜ Tapify (7_6_2026 3：04：28 PM).html' },
    { id: 'vcard76', name: 'Corporate Identity', category: 'Corporate', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v76.png', demoUrl: '../newTemps/tempsNewAdded/Corporate Identity/corporate-identity-vcard ｜ Tapify (7_6_2026 1：29：40 PM).html' },
    { id: 'vcard77', name: 'Kids Toy Store', category: 'Retail', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v77.png', demoUrl: '../newTemps/tempsNewAdded/Dynamic (Kids Toy Store)/Dynamic ｜ Tapify (7_6_2026 12：34：03 PM).html' },
    { id: 'vcard78', name: 'Event Management', category: 'Events', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v78.png', demoUrl: '../newTemps/tempsNewAdded/Event Management/Event-Planner ｜ Tapify (7_6_2026 1：14：38 PM).html' },
    { id: 'vcard79', name: 'Executive Profile', category: 'Business', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v79.png', demoUrl: '../newTemps/tempsNewAdded/Executive Profile/vCard2 Theme (7_6_2026 3：16：11 PM).html' },
    { id: 'vcard80', name: 'Fashion & Beauty', category: 'Beauty', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v80.png', demoUrl: '../newTemps/tempsNewAdded/Fashion Beauty/Makeup Artist ｜ Tapify (7_6_2026 12：58：53 PM).html' },
    { id: 'vcard81', name: 'Gym & Fitness', category: 'Fitness', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v81.png', demoUrl: '../newTemps/tempsNewAdded/Gym/GYM-Trainer ｜ Tapify (7_6_2026 1：21：18 PM).html' },
    { id: 'vcard82', name: 'Lawyer', category: 'Legal', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v82.png', demoUrl: '../newTemps/tempsNewAdded/Lawyer/Lawyer ｜ Tapify (7_6_2026 1：07：01 PM).html' },
    { id: 'vcard83', name: 'Marriage Bureau', category: 'Wedding', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v83.png', demoUrl: '../newTemps/tempsNewAdded/Marriage/Marriage Bureaus ｜ Tapify (7_6_2026 12：12：56 PM).html' },
    { id: 'vcard84', name: 'Modern Edge', category: 'Business', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v84.png', demoUrl: '../newTemps/tempsNewAdded/Modern Edge/Modern-Edge ｜ Tapify (7_6_2026 3：00：57 PM).html' },
    { id: 'vcard85', name: 'Musician', category: 'Music', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v85.png', demoUrl: '../newTemps/tempsNewAdded/Musician/Musician ｜ Tapify (7_6_2026 12：01：20 PM).html' },
    { id: 'vcard86', name: 'Pet Clinic', category: 'Medical', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v86.png', demoUrl: '../newTemps/tempsNewAdded/Pet Clinic/Pet Clinic ｜ Tapify (7_6_2026 12：17：27 PM).html' },
    { id: 'vcard87', name: 'Pet Shop', category: 'Retail', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v87.png', demoUrl: '../newTemps/tempsNewAdded/Pet Shop/Pet Shop ｜ Tapify (7_6_2026 12：23：15 PM).html' },
    { id: 'vcard88', name: 'Photographer', category: 'Creative', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v88.png', demoUrl: '../newTemps/tempsNewAdded/Photographer/Photographer ｜ Tapify (7_6_2026 11：49：08 AM).html' },
    { id: 'vcard89', name: 'Portfolio', category: 'Creative', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v89.png', demoUrl: '../newTemps/tempsNewAdded/Portfolio/portfolio ｜ Tapify (7_6_2026 1：24：12 PM).html' },
    { id: 'vcard90', name: 'Pro Network', category: 'Business', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v90.png', demoUrl: '../newTemps/tempsNewAdded/Pro Network/Pro-Network ｜ Tapify (7_6_2026 1：25：45 PM).html' },
    { id: 'vcard91', name: 'Professional', category: 'Business', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v91.png', demoUrl: '../newTemps/tempsNewAdded/Professional/professional ｜ Tapify (7_6_2026 3：08：05 PM).html' },
    { id: 'vcard92', name: 'Programmer', category: 'Tech', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v92.png', demoUrl: '../newTemps/tempsNewAdded/Programmer/Developer ｜ Tapify (7_6_2026 1：00：04 PM).html' },
    { id: 'vcard93', name: 'Salon', category: 'Beauty', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v93.png', demoUrl: '../newTemps/tempsNewAdded/Salon/Stylish Salon ｜ Tapify (7_6_2026 1：13：35 PM).html' },
    { id: 'vcard94', name: 'School', category: 'Education', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v94.png', demoUrl: '../newTemps/tempsNewAdded/School Template/school ｜ Tapify (7_6_2026 12：44：15 PM).html' },
    { id: 'vcard95', name: 'Simple Contact', category: 'Business', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v95.png', demoUrl: '../newTemps/tempsNewAdded/Simple Contact/vCard (7_6_2026 3：20：16 PM).html' },
    { id: 'vcard96', name: 'Social Media', category: 'Social', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v96.png', demoUrl: '../newTemps/tempsNewAdded/Social Media/influencers ｜ Tapify (7_6_2026 12：51：50 PM).html' },
    { id: 'vcard97', name: 'Social Services', category: 'Nonprofit', isNew: true, image: 'https://tapifyworld.com/assets/img/templates/vcard-v97.png', demoUrl: '../newTemps/tempsNewAdded/Social Services/Social Services ｜ Tapify (7_6_2026 12：29：31 PM).html' },
];
